...
async function startTest() {
    ...
    try {
         ...
         * Never trust local answer/index.
         */
        ...
        /*
         * If backend says all 16 are already
         * answered, finish immediately.
         */
...
function renderTest() {
    ...
    /*
     * Progress represents the number
     * of questions already completed.
     */
    ...
    document
        ...
        .forEach(
            (button) => {
                ...
                /*
                 * Don't disable the buttons here.
                 * User may change their answer
...
async function submitSelectedAnswer() {
    ...
    try {
        ...
        /*
         * Keep local answer array in exact
         * question order.
         */
        ...
        /*
         * CRITICAL:
         * Do NOT increment local index
         * when server rejected the answer.
         */
...
async function finishTest() {
    ...
    /*
     * Prevent two simultaneous finish calls.
     */
    ...
    try {
        ...
        /*
         * Finished session remains on backend.
         * Local test session can be cleared.
         */
        ...
        if (
             ...
             *
             * But if it does, recover instead
             * of throwing user back home.
             */
...
async function startRetest() {
    ...
    try {
        ...
        /*
         * If payment system is not integrated,
         * backend intentionally returns 402.
         */
...
function handleBack() {
    ...
    if (
        ...
        /*
         * Native confirm can be unreliable
         * in some Telegram clients.
         *
         * Use a simple browser confirmation
...
async function init() {
    ...
    /*
     * Normalize invalid saved language.
     */
